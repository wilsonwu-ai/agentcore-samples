"""
Cleanup all AWS resources created by the Claude Agent SDK evaluation sample.
...
parser = argparse.ArgumentParser(description="Cleanup Claude Agent SDK evaluation resources")
...
print("=" * 60)
print("Cleanup — Claude Agent SDK Evaluation Resources")
print("=" * 60)
...
# Also clean evaluation results log group
if _online_path.exists():
    _online_cfg = json.loads(_online_path.read_text())
