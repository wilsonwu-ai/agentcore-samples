"""
Deploy the Google ADK HR Assistant to AgentCore Runtime.
...
Prerequisites:
    ...
    - Bedrock model access enabled for: us.anthropic.claude-sonnet-4-5-20250929-v1:0
      (or set GOOGLE_API_KEY for native Gemini)
"""
...
parser = argparse.ArgumentParser(description="Deploy Google ADK HR Assistant to AgentCore")
parser.add_argument("--region", default="us-east-1", help="AWS region")
parser.add_argument("--name", default="hr-assistant-google-adk", help="Agent runtime name")
...
print("=" * 60)
print("Deploying Google ADK HR Assistant to AgentCore")
print("=" * 60)
print(f"  Region: {REGION}")
print(f"  Name  : {AGENT_NAME}")

# --- Step 1: Deploy via AgentCore CLI ---
print("\n[1/3] Building and deploying container image ...")
